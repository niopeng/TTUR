...
# %j is jobid.
#SBATCH --output=./logs/slurm.test_hrim_x16_31.out
...
# Do all the research.
cp /scratch/nio/srim/HyperRIM/results/Test_HyperRIM_x16_31/n07745940_test_fid/*.png /scratch/nio/srim/HyperRIM/results/Test_HyperRIM_x16_31/n07745940_fid/
python fid.py /scratch/nio/srim/HyperRIM/results/Test_HyperRIM_x16_31/n07745940_fid/ /project/6054857/nio/srim/data/n07745940_512/ --gpu 0 -i /project/6054857/nio/srim/TTUR/
