...
# %j is jobid.
#SBATCH --output=./logs/slurm.test_rfb_6.out
...
# Do all the research.
cp /scratch/nio/srim/SRIM/results/Test_RFB_6/n02279972_test_fid/*.png /scratch/nio/srim/SRIM/results/Test_RFB_6/n02279972_fid/
python fid.py /scratch/nio/srim/SRIM/results/Test_RFB_6/n02279972_fid/ /project/6054857/nio/srim/data/n02279972_512/ --gpu 0 -i /project/6054857/nio/srim/TTUR/
