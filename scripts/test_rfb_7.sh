...
# %j is jobid.
#SBATCH --output=./logs/slurm.test_rfb_7.out
...
# Do all the research.
cp /scratch/nio/srim/SRIM/results/Test_RFB_7/n01531178_test_fid/*.png /scratch/nio/srim/SRIM/results/Test_RFB_7/n01531178_fid/
python fid.py /scratch/nio/srim/SRIM/results/Test_RFB_7/n01531178_fid/ /project/6054857/nio/srim/data/n01531178_512/ --gpu 0 -i /project/6054857/nio/srim/TTUR/
